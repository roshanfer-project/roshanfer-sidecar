...
- **State:** `send_credit_request`, `dispatch_rlp_recv`, `queue_multiplexer`, `check_credit_transmission`, `ppm_client`, `ingress_pre_credit`, `ingress_post_credit`, `prepare_credit_return`, `credit_post_process`, `extract_service_from_rlp_req`
