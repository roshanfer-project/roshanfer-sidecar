...
public:
     ...
     * @todo make it multi-shot
     */
    void prepare_read(std::unique_ptr<Buffer>, UserData*, std::shared_ptr<Listener>, std::shared_ptr<HTTPConnection>);
    ...
    void prepare_write(std::shared_ptr<HTTPConnection>, std::unique_ptr<Buffer>, UserData*);
    void prepare_cancel(std::shared_ptr<HTTPConnection>, UserData*);

    void prepare_rcvmsg(int, std::unique_ptr<Buffer>, UserData*, UDPType);
    void prepare_reply_sendmsg(int, const std::unique_ptr<Buffer>&, std::unique_ptr<Buffer>, UserData*);
    void prepare_req_sendmsg(int, std::unique_ptr<Buffer>, UserData*, struct sockaddr_in);
