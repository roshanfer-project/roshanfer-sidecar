...
class ExponentialMovingAverage {
    public:
        ...
        ExponentialMovingAverage& operator=(const ExponentialMovingAverage&) = delete;
...
class Stats {
    public:
        ...
        LocalMap<ExponentialMovingAverage>& get_avg_service_time_us() { return avg_service_time_us; }
